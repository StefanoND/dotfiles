...
function __fish_spotify_player_global_optspecs
	string join \n t/theme= c/config-folder= C/cache-folder= d/daemon h/help V/version
end
...
complete -c spotify_player -n "__fish_spotify_player_needs_command" -s d -l daemon -d 'Running the application as a daemon'
