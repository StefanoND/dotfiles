...
alias brave='cd ~/ && QT_QPA_PLATFORMTHEME=qt5ct:qt6ct nohup flatpak run com.brave.Browser --enable-features=UseOzonePlatform --ozone-platform=wayland &'
alias bravebrowser='cd ~/ && QT_QPA_PLATFORMTHEME=qt5ct:qt6ct nohup flatpak run com.brave.Browser --enable-features=UseOzonePlatform --ozone-platform=wayland &'
