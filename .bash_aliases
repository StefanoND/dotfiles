...
alias godot='godot & disown'
alias sudenvim='sudo -E nvim'
alias zoom='zoom & disown'
alias syncthing='syncthing & disown'
alias yata='gtk-launch yata & disown'
alias codium='vscodium & disown'
alias code='vscodium & disown'
alias vscode='vscodium & disown'
alias trash='gio trash'
alias rmt='gio trash'
alias headset-charge-indicator='python3 ~/dotfiles/apps/headset-charge-indicator/headset-charge-indicator.py & disown'
alias headsetchargeindicator='python3 ~/dotfiles/apps/headset-charge-indicator/headset-charge-indicator.py & disown'
...
# Wine
#& disown'
alias wine='nohup flatpak run org.winehq.Wine & disown'
# alias wine-gecko='nohup flatpak run org.winehq.Wine.gecko & disown'
# alias wine-mono='nohup flatpak run org.winehq.Wine.mono & disown'
alias winetricks='nohup flatpak run --command=winetricks org.winehq.Wine'
alias winecfg='nohup flatpak run --command=winecfg org.winehq.Wine'
alias wineboot='nohup flatpak run --command=wineboot org.winehq.Wine'

# KDE/QT
alias krita='nohup flatpak run org.kde.krita & disown'
alias kleopatra='nohup flatpak run org.kde.kleopatra & disown'
alias okteta='nohup flatpak run org.kde.okteta & disown'

alias flatseal='nohup flatpak run com.github.tchx84.Flatseal & disown'
alias libreoffice='nohup flatpak run org.libreoffice.LibreOffice & disown'
alias office='nohup flatpak run org.libreoffice.LibreOffice & disown'
alias obsidian='nohup flatpak run md.obsidian.Obsidian & disown'
alias telegram='nohup flatpak run org.telegram.desktop & disown'
# alias discord='nohup flatpak run com.discordapp.Discord --enable-features=UseOzonePlatform --ozone-platform=wayland & disown'
alias discord='nohup flatpak run dev.vencord.Vesktop & disown'
alias vesktop='nohup flatpak run dev.vencord.Vesktop & disown'
...
alias inkscape='nohup flatpak run org.inkscape.Inkscape & disown'
alias blender='nohup flatpak run org.blender.Blender & disown'
alias handbrake='nohup flatpak run fr.handbrake.ghb & disown'
...
alias mullvadbrowser='nohup flatpak run net.mullvad.MullvadBrowser & disown'
alias firefox='nohup flatpak run org.mozilla.firefox & disown'
# alias spotify='nohup flatpak run com.spotify.Client --enable-features=UseOzonePlatform --ozone-platform=wayland & disown'
alias spotify='spotify-launcher & disown'
alias qalculate-qt='nohup flatpak run io.github.Qalculate.qalculate-qt & disown'
alias qalculate='nohup flatpak run io.github.Qalculate.qalculate-qt & disown'
alias gcolor='nohup flatpak run nl.hjdskes.gcolor3 & disown'
alias bitwarden='nohup flatpak run com.bitwarden.desktop & disown'
...
alias dosbox-staging='nohup flatpak run io.github.dosbox-staging & disown'
alias dosbox='nohup flatpak run io.github.dosbox-staging & disown'
alias lime3ds='nohup flatpak run io.github.lime3ds.Lime3DS & disown'
alias ryujinx='DOTNET_SYSTEM_GLOBALIZATION_INVARIANT=0 flatpak run org.ryujinx.Ryujinx & disown'
alias yuzu='nohup flatpak run org.yuzu_emu.yuzu & disown'
alias citra='nohup flatpak run org.citra_emu.citra & disown'
alias cemu='nohup flatpak run info.cemu.Cemu & disown'
alias duckstation='nohup flatpak run org.duckstation.DuckStation & disown'
alias retroarch='nohup flatpak run org.libretro.RetroArch & disown'
alias n64emu='nohup flatpak run com.github.Rosalie241.RMG & disown'
alias project64='nohup flatpak run com.github.Rosalie241.RMG & disown'
alias dolphin-emu='nohup flatpak run org.DolphinEmu.dolphin-emu & disown'
alias dolphin-emulator='nohup flatpak run org.DolphinEmu.dolphin-emu & disown'
alias PCSX2='nohup flatpak run net.pcsx2.PCSX2 & disown'
alias ps2emu='nohup flatpak run net.pcsx2.PCSX2 & disown'
alias RPCS3='nohup flatpak run net.rpcs3.RPCS3 & disown'
alias ps3emu='nohup flatpak run net.rpcs3.RPCS3 & disown'

alias heroicgameslauncher='nohup flatpak run com.heroicgameslauncher.hgl & disown'
alias heroic='nohup flatpak run com.heroicgameslauncher.hgl & disown'
alias gdlauncher='nohup flatpak run io.gdevs.GDLauncher & disown'
alias playonlinux='nohup flatpak run org.phoenicis.playonlinux & disown'
alias boxes='nohup flatpak run org.gnome.Boxes & disown'
alias gnome-boxes='nohup flatpak run org.gnome.Boxes & disown'
alias bottles='nohup flatpak run com.usebottles.bottles & disown'
alias atoms='nohup flatpak run pm.mirko.Atoms & disown'

alias teams='nohup flatpak run com.github.IsmaelMartinez.teams_for_linux & disown'
...
# alias ='nohup flatpak run  & disown'
