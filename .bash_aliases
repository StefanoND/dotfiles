...
alias duckstation='cd ~/ && nohup gamemoderun flatpak run org.duckstation.DuckStation &'
alias retroarch='cd ~/ && nohup gamemoderun flatpak run org.libretro.RetroArch &'
alias n64emu='cd ~/ && nohup gamemoderun flatpak run com.github.Rosalie241.RMG &'
...
# alias duckstation='cd ~/ && nohup gamemoderun gamescope -w 1920 -h 1080 -r 144 -f -- flatpak run org.duckstation.DuckStation &'
# alias retroarch='cd ~/ && nohup gamemoderun gamescope -w 1920 -h 1080 -r 144 -f -- flatpak run org.libretro.RetroArch &'
# alias n64emu='cd ~/ && nohup gamemoderun gamescope -w 1920 -h 1080 -r 144 -f -- flatpak run com.github.Rosalie241.RMG &'
