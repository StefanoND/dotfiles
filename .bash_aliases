...
alias dolphin='cd ~/ && nohup QT_QPA_PLATFORMTHEME=qt5ct:qt6ct dolphin &'
...
# alias discord='cd ~/ && nohup flatpak run io.github.spacingbat3.webcord --enable-features=UseOzonePlatform --ozone-platform=wayland &'
alias webcord='cd ~/ && nohup flatpak run io.github.spacingbat3.webcord --enable-features=UseOzonePlatform --ozone-platform=wayland &'
