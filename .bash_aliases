...
alias codium='nohup codium & disown'
# alias codium='nohup codium --password-store="kwallet5" & disown'
alias code='nohup vscodium & disown'
alias vscode='nohup vscodium & disown'
...
alias torbrowser='nohup /usr/bin/torbrowser-launcher & disown'
