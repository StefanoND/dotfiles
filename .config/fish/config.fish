...
# set -gx fish_user_paths $MASON_BIN $EMACS_BIN $NVM_BIN $ATUIN_BIN $YARN_NODEMODULES_BIN $YARN_BIN $NWSCRIPTD_BIN $NWSCRIPTLINT_BIN $NIMBLE_BIN $DOTNET_ROOT $DOTNET_TOOLS $CARGO_BIN $LOCAL_BIN $fish_user_paths
set -gx PATHS $MASON_BIN $EMACS_BIN $NVM_BIN $ATUIN_BIN $YARN_NODEMODULES_BIN $YARN_BIN $NWSCRIPTD_BIN $NWSCRIPTLINT_BIN $NIMBLE_BIN $DOTNET_ROOT $DOTNET_TOOLS $CARGO_BIN $LOCAL_BIN $PATH

if status is-login
    contains $PATHS
    or set -q -gx PATH $PATHS
end
