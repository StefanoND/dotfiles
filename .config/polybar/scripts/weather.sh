...
# Downloaded from: https://github.com/GuidoFe/weather-polybar-plugin
...
URL="api.openweathermap.org/data/2.5/weather?q=$(echo "$CITY_NAME"| sed 's/ /%20/g'),$COUNTRY_CODE&appid=$APIKEY$UNIT_URL&lang=$LANG"
